...
public class Consts {
	...
	public static final class Api {
		...
		public static final String	SEARCH = "/movies.json?q=%s&page_limit={limit}&page=1&apikey={key}";
		public static final String	BOX_OFFICE = "/lists/movies/box_office.json?limit={limit}&country=us&apikey={key}";
		public static final String	IN_THEATERS = "/lists/movies/in_theaters.json?page_limit={limit}&page=1&country=us&apikey={key}";
