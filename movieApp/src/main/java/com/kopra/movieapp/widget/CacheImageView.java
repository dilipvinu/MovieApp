...
public class CacheImageView extends NetworkImageView {
    ...
    /**
     * Image to be used as a placeholder until the network image is loaded.
     */
    ...
    /**
     * Callback invoked when image has finished loading
     */
    ...
    /**
     * Sets the default image to be used for this view until the attempt to load it
     * completes.
     */
    ...
    /**
     * Sets the callback to be invoked when the image has finished loading
     */
